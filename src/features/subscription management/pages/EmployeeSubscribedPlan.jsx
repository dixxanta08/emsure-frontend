        ...
        <div className=" p-4 mt-4  rounded-md flex flex-col gap-8 mb-4">
          <div className="w-full grid grid-cols-2 gap-4">
            <div>
              ...
              <Link
                to={`/subscription-management/plan-subscriptions/${employeeSubscriptionData?.subscriptionId}/details`}
              >
            ...
            <div>
              ...
              <Link
                to={`/people-organizations/companies/${employeeSubscriptionData?.companyId}/employees/${employeeSubscriptionData?.employeeId}/details`}
              >
                <p className="text-purple-500 hover:text-purple-800 underline  font-semibold">
        ...
        <div className="flex items-center justify-end gap-4">
          {isEmployeeSubscriptionDataLoading || isPendingPaymentLoading ? (
            ...
            <p className="text-sm font-semibold text-red-500">
              Policy holder has pending payments.
            </p>
          ) : (
