          ...
          <div className=" grid grid-cols-1 md:grid-cols-2 gap-8 py-4 ">
            <div className="p-4  rounded-md border border-gray-300">
              ...
              <div className="grid grid-cols-2 gap-1">
                ...
                <Link
                  to={`/subscribed-plans/${claimData?.subscriptionId}/employee/${claimData?.employeeId}`}
                >
            ...
            <div className="p-4  rounded-md border border-gray-300">
              ...
              <div className="grid grid-cols-2 gap-1">
                ...
                <p>{claimDetails?.totalClaimable}</p>
              </div>
            </div>
            ...
            <div className="p-4  rounded-md border border-gray-300">
              ...
              <div className="my-2">
                ...
                {/* files */}
                {claimData?.claimDocumentUrl && (
                  <>
                    <h3 className="mt-2 font-semibold">Attached Document</h3>
                    <a
                      className="w-full  "
                      href={claimData?.claimDocumentUrl}
                      target="_blank"
                    >
                      <p className="w-full p-1 my-2  bg-slate-200 rounded inline-flex items-center gap-2 text-slate-800">
