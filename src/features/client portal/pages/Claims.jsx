...
const CompanyClaims = () => {
  ...
  const { data, error, isLoading, isFetching } = useQuery({
    ...
    queryFn: async () => {
      if (isCompanyRoute) {
        return await claimService.getClaimsByCompanyId(
          companyId,
          pageIndex,
          pageSize,
          searchTerm,
        ...
        return await claimService.getClaimsByEmployeeId(
          employeeId,
          pageIndex,
          pageSize,
          searchTerm,
  ...
  const handleRowClick = (row) => {
    navigate(`/claims/${row.claimId}/details`); // Updated to use claimId instead of employeeId
  };
